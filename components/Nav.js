      ...
      <nav className={`${styles.navbar} ${showNavbar ? styles.show : styles.hide}`}ref={navbarRef} >
        ...
        <div className={styles.hamburger} onClick={toggleMenu}>
          ...
          <div className={styles.close_logo_container}>
                ...
                <Link href="/" onClick={() => handleLinkClick("/")}>{formData?.shopName}</Link>
               </div>
          ...
          {/* Sidebar component */}
            ...
            <li>
              {user ? (
                ...
                <Link href="/me/profile" onClick={() => handleLinkClick("/me/profile")}><div className={`${styles.loginLink} ${styles.userActive}`}>
        ...
        {/* Full screen side panel (opens left to right) 
          ...
          <div className={styles.mobnavbarHeader}>
            ...
            <div className={styles.moblogo}>
              <Link onClick={() => handleLinkClick("/")} href="/">{formData?.shopName}</Link>
            </div>
          ...
          <ul className={styles.navItems}>
            ...
            */}
            ...
            <li><Link onClick={() => handleLinkClick("/guid")} href="/guid">Guide</Link></li>
            ...
            <li><Link onClick={() => handleLinkClick("/support")} href="/support">Support</Link></li>
      ...
      <p>© copyright by {formData?.shopName}, All Rights Reserved</p>
        ...
        <Link onClick={() => handleLinkClick("/search")} href="/search">
         ...
         <span> Search </span>
          ...
          {user ? 
            <Link onClick={() => handleLinkClick("/me/profile")} href="/me/profile">
