...
// import { FaStar, FaSearch, FaBars, FaTimes, FaTag, FaFilter, FaSortAmountUp, FaSortAmountDown } from 'react-icons/fa';
...
//   useEffect(() => {
//     filterProducts();
//   }, [selectedRating, selectedCategory, minPrice, maxPrice, query]);
...
// {selectedRating ? (
//   <>
//     <h4  className={styles.allheading}>Filtered Products with {selectedRating} Star Rating</h4>
...
//             <img src={product.media[0]} alt={product.name} className={styles.productImage} />
...
//                     key={index}
//                     size={20}
//                     color={index + 1 <= product.averageRating ? '#ffc107' : '#e4e5e9'}
//                   />
//                 ))}
//               </div>
//             </div>
...
//       </div>
//     ) : (
//       <p>No products found with {selectedRating} star rating.</p>
//     )}
//   </>
// ) : (
//   <>
//   <h4  className={styles.allheading} >All Products</h4>
//   <div className={styles.productsGrid}>
...
//                <div className={styles.smallProductRating}>
