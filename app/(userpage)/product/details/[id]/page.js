...
import { FaStar, FaHome, FaFacebookF, FaTwitter, FaCopy, FaArrowLeft, FaArrowRight, FaLinkedinIn, FaShareAlt, FaWhatsapp } from 'react-icons/fa';
  ...
  return (
    <div className={styles.productDetails}>
      {product ? (
        ...
        <Link href="/">{product?.categoryName}</Link>
      ...
      //           />
            ...
            <div className={styles.productcontent}>
              ...
              <div className={styles.rating}>
                <h3>Average Rating: {calculateAverageRating(product.reviews)}</h3>
                {[...Array(5)].map((_, index) => (
                  <FaStar
                    key={index}
                    size={20}
    ...
    <h2 className={styles.producthad}>Recommended Products</h2>
      ...
      <div className={styles.productGrid}>
        {recommendedProducts.map((recommendedProduct) => (
          <div key={recommendedProduct._id} className={styles.productItem}>
            ...
            <p className={styles.productDescription}>{trimText(recommendedProduct.description, 50)}</p>
            </Link>
          </div>
        ))}
      </div>
