...
//                 <p className={styles.productId}><strong>Product ID:</strong> {product._id}</p>
...
//                       <div className={styles.review}>
//                         <div className={styles.reviewHeader}>
//                           <p><strong>Review ID:</strong> {review?._id || 'Unknown'}</p>
//                           <p><strong>User:</strong> {review.user?.username || 'Unknown'}</p>
//                           <button 
//                             className={styles.deleteButton}
//                             onClick={() => deleteReview(product._id, review._id)}>
//                             Delete Review
