...
//       <label htmlFor="text" className={styles.label}>Email</label>
//       <input
//         type="text"
//         placeholder="Name"
//         value={newProduct.name}
//         onChange={(e) => setNewProduct({ ...newProduct, name: e.target.value })}
//       />
//       <label htmlFor="Description" className={styles.label}>Email</label>
//       <textarea
//        type="Description"
//         placeholder="Description"
//         value={newProduct.description}
...
//       <label htmlFor="number" className={styles.label}>Email</label>
...
//     <div>
//       <label>Select Display Options:</label>
//      <select
// value={newProduct.displayOptions}
// onChange={(e) => setNewProduct({ ...newProduct, displayOptions: e.target.value })}
// >
...
//       {/* Image Upload     <input type="file" multiple onChange={handleImageChange} /> */}
...
//       <div className={styles.imagePreviewContainer}>
//         {imagePreviews.map((preview, index) => (
//           <img key={index} src={preview} alt="Preview" className={styles.imagePreview} />
//         ))}
//       </div>
