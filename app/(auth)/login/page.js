...
//       localStorage.setItem('token', response.data.token); // Ensure token is saved here
      ...
      <div className={styles.formContainer}>
        {isLogin ? (
          ...
          height={50} />
            ...
            <h1 className={styles.title}>Login with your email & password</h1>
          ...
          width={50}
          height={50} />
          <h1 className={styles.title}>By signing up, you agree to our terms & policy</h1>
          </div>
        ...
        <div onClick={handleSwitch} className={styles.switchButton}>
          {isLogin ? <p>Don&#39;t have any account?<span> register </span> </p>
             : 
